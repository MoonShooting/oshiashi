...
public interface RouteSpotRepository extends JpaRepository<RouteSpotEntity, RouteSpotId> {
	...
	List<RouteSpotEntity> findByRoute_RouteIdOrderByVisitOrderAsc(Long routeId);

    Optional<RouteSpotEntity> findByRouteSpotIdAndRoute_RouteId(Long routeSpotId, Long routeId);
}
